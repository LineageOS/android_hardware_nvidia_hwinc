...
typedef enum
{
    ...
    NvBootSeRsaKeySlot_Num = ARSE_RSA_NUM_KEY_SLOTS,
 ...
 */
enum {NVBOOT_SE_RSA_MAX_MODULUS_SIZE_BITS = ARSE_RSA_MAX_MODULUS_SIZE};
enum {NVBOOT_SE_RSA_MAX_MODULUS_SIZE_BYTES = ARSE_RSA_MAX_MODULUS_SIZE / 8};
enum {NVBOOT_SE_RSA_MAX_MODULUS_SIZE_WORDS = NVBOOT_SE_RSA_MAX_MODULUS_SIZE_BYTES / 4};
enum {NVBOOT_SE_RSA_MAX_EXPONENT_SIZE_BITS = ARSE_RSA_MAX_MODULUS_SIZE};
enum {NVBOOT_SE_RSA_MAX_EXPONENT_SIZE_BYTES = ARSE_RSA_MAX_MODULUS_SIZE / 8};
enum {NVBOOT_SE_RSA_MAX_EXPONENT_SIZE_WORDS = NVBOOT_SE_RSA_MAX_MODULUS_SIZE_BYTES / 4};
